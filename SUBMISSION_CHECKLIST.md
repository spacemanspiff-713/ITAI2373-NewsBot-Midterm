...
- [x] Modules 1-8 are represented in the notebook
- [x] Multiple classifiers are compared
- [x] Final NewsBot system processes new articles
- [x] Saved outputs are present in `outputs/`
- [x] Notebook logic was validated locally

## Documentation
- [x] README uses relative links
- [x] README includes an AI usage overview
- [x] Reflection outline is filled in
- [x] Final reflection draft is included
- [x] Bonus Streamlit app is included in the repo
